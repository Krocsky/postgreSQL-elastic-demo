...
function floor(number) {
  var decimalLimit = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 2;
...
function hideStr(str, len) {
  ...
  if (len > 0) {
    return chars.reduce(function (ret, char, index) {
    ...
    return chars.reduceRight(function (ret, char, index) {
 ...
 * @param {*} separator 分隔符
 */
function separate(str, blockLength) {
