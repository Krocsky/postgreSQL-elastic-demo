...
function chk_bankno(bankno) {
  ...
  var newArr = [];
  for (var i = first15Num.length - 1; i > -1; i -= 1) {
    // 前15或18位倒序存进数组
...
module.exports = {
  chk_id: chk_id,
  chk_mobile: chk_mobile,
  chk_bankno: chk_bankno,
  chk_email: chk_email,
  chk_check_code: chk_check_code,
  chk_decimal: chk_decimal,
  chk_login_pwd: chk_login_pwd,
  chk_pay_pwd: chk_pay_pwd
};